...
if(@$_GET['fdid'] && $_SESSION['key']=='AntekC1') {
$id=@$_GET['fdid'];
$result = mysqli_query($con= new mysqli('localhost','root','','test(egzamin)'),"DELETE FROM feedback WHERE id='$id' ") or die('Error');
...
//delete user
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='AntekC1') {
$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='AntekC1') {
$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='AntekC1') {
$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='AntekC1') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
